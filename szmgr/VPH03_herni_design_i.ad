...
[quote, Jesse Schell, Art of Game Design (2008)]
____
A game is a problem-solving activity, approached with a playful attitude.
____

[quote, Salen & Zimmerman, Rules of Play (2004)]
____
...
image::./img/vph03_bartle.png[width=500rem]
...
IMPORTANT: Herní zážitky souvisí s pojmem obtížnost, kterému se věnuje část otázky link:../herni-design-ii/[Herní design II].

==== LeBlanc's Eight Kinds of Fun

TIP: Taky označované jako _Taxonomy of Game Pleasures_ a _herní "pošušňáníčka"_. <<pa215-2019>>
...
IMPORTANT: Testováním se více zabývá otázka link:../herni-design-ii/[Herní design II].

== Game Designer

[quote, ZZho slidy z Herního inkubátoru]
____
Artist = inner calling = intimate.

To create a game is not intimate.

[.small]#In a small team it is possible.#
...
Cíl::
* [.line-through]#Cílem game designera je vytvořit hru.#
* [.line-through]#Cílem game designera je vytvořit nějaký zážitek.#
...
* link:https://twinery.org/[Twine],
* link:http://www.bitsy.org/#0,0[Bitsy],
* link:https://www.flickgame.org/[Flickgame].
...
[quote, Ano&comma; stále ZZ]
____
[.underline]#Design theory is like coffee.#
...
[quote, Jesse Schell, Art of Game Design (2008)]
____
By deep listening to your own self, that is, *observing*, *evaluating*, and *describing* your own experiences, *you can make rapid, decisive judgements* about what is and is not working in your game, [.underline]#*and why*# it is or is not working.
____
...
NOTE: Ontologie -- disciplína zabývající se bytím a základními pojmy jako je realita, existence, atp.
...
image::./img/vph03_cgo.svg[width=100%]
...
* link:http://www.costik.com/nowords2002.pdf[Greg Costikyan: I Have No Words & I Must Design: Toward a Critical Vocabulary for Game]
